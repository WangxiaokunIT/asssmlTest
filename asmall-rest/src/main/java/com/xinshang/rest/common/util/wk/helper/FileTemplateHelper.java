...
import com.xinshang.rest.common.util.wk.helper.param.FileTemplateParamUtil;
...
public class FileTemplateHelper {
	 ...
	 */
	public static JSONObject createFileByUpload(String filePath, String fileName, String accountId) throws DefineException {
		log.info("filePath:{},fileName:{},accountId:{}",filePath,fileName,accountId);
	...
	public static void streamUpload(String filePath, String uploadUrl) throws DefineException {
		...
		String conentType = "application/pdf";
