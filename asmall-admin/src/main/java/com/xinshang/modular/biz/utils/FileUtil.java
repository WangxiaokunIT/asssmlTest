...
public class FileUtil {
    ...
    @SneakyThrows
    public Map<String, Object> uploadFilePath(MultipartFile file, HttpServletRequest request, String type){
        SystemProperties upmsProperties = SpringContextHolder.getBean(SystemProperties.class);
        ...
        if(upmsProperties.getOssOpen()){
            ...
            map = uploadFileServer(file, request, type);
        }
        return map;
    }
    @SneakyThrows
