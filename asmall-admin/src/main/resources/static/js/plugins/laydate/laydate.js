...
;!function () {
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        console.log(this.config.format.match)
        console.log(this.config.format.match(new RegExp(n + "|.", "g")))
        var e = this;
        var t= e.config;
        console.log(t.format.match)
        var n = "yyyy|y|MM|M|dd|d|HH|H|mm|m|ss|s", a = "static" === t.position,
