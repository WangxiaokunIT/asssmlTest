 ...
 */
public class SystemGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void globalConfig() {
        ...
        globalConfig.setAuthor("zhangjiajia");
    }
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://192.168.1.254:3306/asmall?characterEncoding=utf8");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.xinshang.admin.common.persistence.model");
        packageConfig.setMapper("com.xinshang.admin.common.persistence.dao");
        packageConfig.setXml("com.xinshang.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.xinshang.admin");
        contextConfig.setCoreBasePackage("com.xinshang.core");
        contextConfig.setBizChName("字典管理");
        contextConfig.setBizEnName("sysDict");
        contextConfig.setModuleName("system");
        contextConfig.setProjectPath("D:\\ideaSpace\\asmall\\asmall-admin");//写自己项目的绝对路径
