        ...
        return this.each(function() {
            ...
            this.createHtml = function() {
                ...
                if (para.dragDrop) {
                    ...
                    html += "		</div>";
                    html += '<div class="panel-body" id="uploadPannel" style="padding:0;display:none">';
                    html += '   <div class="panel-group" id="accordion">';
                    html += '        <div class="panel panel-default">';
                    html += '            <div class="panel-heading">';
                    html += '                <h5 class="panel-title">';
                    html += '                    <a data-toggle="collapse" href="#collapseOne" data-parent="#accordion">已上传文件</a>';
                    html += '                </h5>';
                    html += '            </div>';
            ...
            this.funDisposePreviewHtml = function(file, e) {
                ...
                var newStr = file.name.split("").reverse().join("");
                var type = newStr.split(".")[0].split("").reverse().join("");
                var fileImgSrc = "/static/css/plugins/zyupload/skins/images/fileType/" + type + ".png";
