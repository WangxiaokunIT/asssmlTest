(function (window) {
  ...
  function getRandomImg() {
    return '/static/img/captcha/' + getRandomNumberByRange(1, 100)+".jpg";
  }
  ...
  class jigsaw {
    ...
    initDOM() {
      ...
      addClass(canvas,"kaptcha");
      const block = canvas.cloneNode(true) // 滑块
      addClass(block,"kaptcha-block");
      ...
      float.appendChild(refreshIcon)
      float.appendChild(block)
