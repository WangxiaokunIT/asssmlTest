...
DeptInfoDlg.onClickDept = function(e, treeId, treeNode) {
    $("#parentName").attr("value", DeptInfoDlg.zTreeInstance.getSelectedVal());
...
DeptInfoDlg.collectData = function() {
    this.set('id').set('simpleName').set('fullName').set('remark').set('sortNum').set('parentId');
}
