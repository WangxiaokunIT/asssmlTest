...
@Component
@Scope("prototype")
public class DictSelectorConTag extends Tag {
    ...
    public void render(){
        ...
        html.append("<div class=\"input-group-btn\"><button data-toggle=\"dropdown\" class=\"btn btn-white dropdown-toggle\" type=\"button\">"+label+"</button>\r\n");
        html.append("</div>\r\n");
