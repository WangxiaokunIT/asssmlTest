...
//	}
    ...
    public static String replaceFieldIdToName(String filedName){
        if(filedName.endsWith("Id")){
            filedName=filedName.substring(0,filedName.length()-2);
        }
        return filedName+"Name";
    }
     ...
     * @return
     */
    private Object split(String str,String splitStr) {
