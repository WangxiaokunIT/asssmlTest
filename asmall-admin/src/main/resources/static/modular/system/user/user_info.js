...
UserInfoDlg.onClickDept = function (e, treeId, treeNode) {
    $("#citySel").attr("value", UserInfoDlg.userDeptTree.getSelectedVal());
...
UserInfoDlg.collectData = function () {
    this.set('id').set('account').set('sex').set('password').set('avatar')
        .set('email').set('name').set('fullName').set('birthday').set('rePassword').set('deptId').set('phone');
};
...
UserInfoDlg.addSubmit = function () {
    ...
    var ajax = new $ax(Feng.ctxPath + "/mgr/add", function (data) {
        Feng.success("添加成功!");
        if(window.parent&&window.parent.MgrUser&&window.parent.MgrUser.rightClickTreeNode) {
...
UserInfoDlg.editSubmit = function () {
    ...
    var ajax = new $ax(Feng.ctxPath + "/mgr/edit", function (data) {
        Feng.success("修改成功!");
        if(window.parent.MgrUser&&window.parent.MgrUser.rightClickTreeNode) {
            window.parent.MgrUser.refreshGrandfatherNode();
        }
        if (window.parent.MgrUser) {
            window.parent.MgrUser.table.refresh();
            UserInfoDlg.close();
        }
    }, function (data) {
...
$(function () {
    ...
    ztree.init();
    UserInfoDlg.userDeptTree = ztree;
