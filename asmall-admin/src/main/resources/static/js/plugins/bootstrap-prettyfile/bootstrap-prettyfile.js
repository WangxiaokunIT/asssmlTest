...
( function( $ ) {
    $.fn.extend({
        prettyFile: function( options ) {
            ...
            function make_form( $el, text, hide) {
                $el.wrap('<div></div>');
                ...
                if(!hide) {
                    ...
                    $el.after( '\
                        <div class="input-append">\
                            <input class="input-large form-control" type="text" placeholder="' + text + '" readonly>\
                        </div>\
                    ' );
                }
            ...
            return plugin.each( function() {
                ...
                if ( $this ) {
                    ...
                    $wrap = make_form( $this, options.text, options.hidden );
